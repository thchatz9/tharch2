#		ΕΡΓΑΣΤΗΡΙΟ 2 ΧΑΤΖΟΠΟΥΛΟΣ ΑΘΑΝΣΙΟΣ 8274 ΓΚΑΒΕΖΟΣ ΑΝΤΩΝΙΟΣ 8992
...
### ΠΑΡΑΤΗΡΗΣΕΙΣ ΠΑΝΩ ΣΤΟ ΕΡΓΑΣΤΗΡΙΟ 2
		...
		Αρχικά ο τρόπος που προσπάθησα να εκτελέσω τα βήματα ήταν πολύ πιο οικείως σε σχέση με το πρώτο εργαστήριο καθώς υπήρχε μία εξοικείωση.
		...
		Έπειτα , ανέφερα και στην αναφορά παραπάνω πως είχα θέμα με την δημιουργία γραφημάτων καθώς δεν μπορούσα να τα κάνω  copy paste από τα windows και στο ubuntu τα έβγαζε κάπως περίεργα ένω τα δεδομένα του βήματος 2.2 δεν τα έβγαζε καθόλου. 
		Παρόλα αυτά βρήκα ιδιαίτερα ενδιαφέρον το ότι μπορείς μέσα από θεωρητικές εξομοιώσεις της λειτουργείας ενός επεξεργαστή ότι μπορείς να πάρεις χρήσιμα δεδομένα για το πώς μπορείς να βελτιώσεις την απόδοση του και τι κόστος έχει κάθε επιλογή σου τόσο σε χρόνο όσο και σε πολυπλοκότητα - χρήμα.
